...
module_gcamindia_LA101.energy_balance <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-india/A10.EB_FuelMap",
             ...
             FILE = "gcam-india/A10.EB_bld_SecFuel_mtoe",
             FILE = "gcam-india/A10.EB_bld_SecFuel_EJ"))
    ...
    A10.EB_bld_SecFuel_mtoe          <- get_data(all_data, "gcam-india/A10.EB_bld_SecFuel_mtoe")
    A10.EB_bld_SecFuel_EJ            <- get_data(all_data, "gcam-india/A10.EB_bld_SecFuel_EJ") %>% gather_years()
    ...
    L101.india_state_EB_EJ_state_S_F <- rbind (A10.EB_bld_SecFuel_EJ, L101.india_state_EB_EJ_state_S_F)
    ...
    L101.india_state_A10.EB_SecFuel_mtoe %>%
      ...
      add_precursors("gcam-india/A10.EB_SecFuel_mtoe",
                     ...
                     "gcam-india/A10.EB_bld_SecFuel_mtoe") ->
      L101.india_state_A10.EB_SecFuel_mtoe
    ...
    L101.india_state_EB_EJ_state_S_F %>%
      ...
      add_precursors("gcam-india/A10.EB_SecFuel_mtoe",
                     ...
                     "gcam-india/A10.EB_bld_SecFuel_mtoe",
                     "gcam-india/A10.EB_bld_SecFuel_EJ") ->
      L101.india_state_EB_EJ_state_S_F
